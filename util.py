...
def A3Load():
    # Set A3 directory
    DIR = os.path.join(os.path.expanduser("~"), '189/content/A3P_data/')
...
def train2(train_data_1, train_data_2, numFilt):
    '''
    TODO: modify the code/ move to my 
    '''

    numTrials_1 = np.size(train_data_1,0)
    numTrials_2 = np.size(train_data_1,0)

    # train the CSP filters 
    ccacsp_filts = calc_CSP(train_data_1, train_data_2, numFilt)
...
def calc_CSP(x1,x2, numFilt):
    '''
    Modified calc_CSACCP to make it work with CSP
    '''
